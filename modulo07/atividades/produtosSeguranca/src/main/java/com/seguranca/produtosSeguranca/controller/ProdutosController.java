...
public class ProdutosController {
   ...
   public ResponseEntity<List<ProdutosModel>> buscarProdutosCadastrados(){
        return ResponseEntity.ok(produtosService.buscarProdutos());
    }

    @PostMapping(value = "/produtos/create")
    public ResponseEntity<ProdutosModel> cadastrarUmProduto(@RequestBody ProdutosModel produtosModel){
