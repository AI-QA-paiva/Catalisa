...
public class TopicoController {
    ...
    public TopicoModel cadastrarTopico(@RequestBody TopicoModel topicoModel){//, RespostaModel respostaModel
        return topicoService.cadastrarTopico(topicoModel);//,respostaModel
    }
